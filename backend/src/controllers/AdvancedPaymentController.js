...
const paymentService = require('../services/PLACEHOLDER');
...
router.post('/apple-pay', async (req, res) => {
  try {
    ...
    const payment = await paymentService.__PLACEHOLDER(bookingId, amount, applePayToken);
...
router.post('/google-pay', async (req, res) => {
  try {
    ...
    const payment = await paymentService.__PLACEHOLDER(bookingId, amount, googlePayToken);
...
router.post('/paypal/:paymentId/execute', async (req, res) => {
  try {
    ...
    const payment = await paymentService.__PLACEHOLDER(paymentId, { email });
...
router.post('/subscriptions/:subscriptionId/billing', async (req, res) => {
  try {
    ...
    const payment = await paymentService.__PLACEHOLDER(subscriptionId);
